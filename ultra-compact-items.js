(() => {
  ...
  style.textContent = `
    ...
    .list-header,.list-row{
      display:grid;
      grid-template-columns:92px 78px minmax(150px,1.45fr) 105px 50px 88px 64px 105px 66px 82px 86px 68px 118px;
      gap:4px;
      align-items:center;
      min-width:1198px;
    }
    ...
    @media(max-width:760px){
      .list-header,.list-row{min-width:1138px}
      .list-detail{min-width:988px}
    }
  `;
